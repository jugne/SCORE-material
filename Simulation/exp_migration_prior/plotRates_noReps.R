...
true_rates_file <- "rates_mig_exp.csv"
...
ggsave(plot=p.Ne_1,paste("Figures/type_1_Ne_sim_",gen_information[[g]], ".pdf", sep=""),width=6, height=5)
ggsave(plot=p.rea_1,paste("Figures/type_1_rho_sim_",gen_information[[g]], ".pdf", sep=""),width=6, height=5)
ggsave(plot=p.mig_1,paste("Figures/type_1_mig_sim_",gen_information[[g]], ".pdf", sep=""),width=6, height=5)
ggsave(plot=p.Ne_2,paste("Figures/type_2_Ne_sim_",gen_information[[g]], ".pdf", sep=""),width=6, height=5)
ggsave(plot=p.rea_2,paste("Figures/type_2_rho_sim_",gen_information[[g]], ".pdf", sep=""),width=6, height=5)
ggsave(plot=p.mig_2,paste("Figures/type_2_mig_sim_",gen_information[[g]], ".pdf", sep=""),width=6, height=5)
