...
h = fopen('rates.csv', 'w');fprintf(h, 'run,Ne_1,Ne_2,reassortment_1,reassortment_2,migration_1, migration_2 \n');
...
%         for r = 1 : 3
            ...
            g = fopen(sprintf('inference/inf_%s_%d.xml', evol_name{uncertainty}, i), 'w');
